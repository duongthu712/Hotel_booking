<%-- Author: ThuDNM-HE204370 Date created: 23/06/2026 Purpose: Check-in page. --%>
            ...
            <%@taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
                ...
                <body>
                    ...
                    <div class="container">
                        ...
                        <c:if test="${not empty param.searchBookingCode and empty booking}">
                            <div class="alert alert-danger"
                                style="text-align: center; margin-top: 15px; margin-bottom: 15px; padding: 10px; background-color: #fee2e2; color: #991b1b; border-radius: 6px; font-weight: 500; font-family: 'Lora', serif; font-size: 14px;">
                                Không tìm thấy đơn đặt phòng hợp lệ với mã:
                                <strong>${fn:escapeXml(param.searchBookingCode)}</strong>. Vui lòng kiểm tra lại.
                            </div>
                        </c:if>
                        ...
                        <c:if test="${not empty booking}">
                            <div class="main-card searched-booking-card">
                                <div class="card-header-flex">
                                    ...
                                    <a href="${pageContext.request.contextPath}/checkin" class="btn-close-view">✕ Đóng
                                        kết
                                        quả xem</a>
                                </div>
                                ...
                                <div class="info-block">
                                    ...
                                    <c:if
                                        ...
                                        <p><strong>Thời gian nhận phòng:</strong> <span
                                                class="text-success-highlight">${fn:substring(booking.actualCheckInTime,
                                                0,
                                                19)}</span></p>
                                    </c:if>
                                    ...
                                    <c:if test="${not empty booking.expectedCheckInTime}">
                                        <p><strong>Lịch hẹn gọi điện:</strong> <span style="font-weight: 600;">Khách báo
                                                đến
                                                lúc ${fn:substring(booking.expectedCheckInTime, 0, 5)}</span></p>
                                        <p><strong>Ghi chú cuộc gọi:</strong> <span class="text-muted"
                                                style="font-style: italic; color: #4b5563;">"${booking.callNote}"</span>
                                        </p>
                                    </c:if>
                        ...
                        <c:choose>
                            <c:when test="${notTodayCheckIn}">
                                <button type="button" class="btn-success btn-disabled"
                                    style="background-color: #94a3b8; cursor: not-allowed; opacity: 0.7;" disabled>Chưa
                                    đến
                            ...
                            <c:otherwise>
                                ...
                                <c:if test="${booking.status eq 'Đã xác nhận'}">
                                    <button type="submit" name="action" value="cancel"
                                        class="btn-success btn-danger-flat"
                                ...
                                <c:forEach items="${listToday}" var="b">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <c:if
                                                test="${not empty b.expectedCheckInTime and b.status eq 'Đã xác nhận'}">
                                        ...
                                        <td class="time-col-text">
                                            <c:choose>
                                                <c:when
                                                    ...
                                                    <span class="text-success-time">${fn:substring(b.actualCheckInTime,
                                                        11,
                                                        19)}</span>
                                                </c:when>
                                                <c:otherwise>
