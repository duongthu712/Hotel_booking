<%-- Document : hotel-info-management Created on : May 27, 2026, 10:49:38 PM Author : Minh Thu Editor : LinhLTHE200306
    --%>
                    ...
                    <%@page import="model.HotelInfo" %>
                        <%@page import="model.HotelImage" %>
                            <%@page import="model.HotelNews" %>
                                <link rel="stylesheet"
                                    href="${pageContext.request.contextPath}/view/assets/css/common.css"
                                    type="text/css">
                                <link rel="stylesheet"
                                    href="${pageContext.request.contextPath}/view/assets/css/hotel-info-management.css"
                                    type="text/css">
                                <!DOCTYPE html>
                                <html>
                                        ...
                                        <%@ include file="/view/staff/navbar.jsp" %>
                                            ...
                                            <main class="content-container">
                                                ...
                                                <c:if test="${not empty sessionScope.errorMessage}">
                                                    <div class="alert-message alert-error">${sessionScope.errorMessage}
                                                    </div>
                                                ...
                                                <div class="hotel-popup ${not empty openInfoModal ? 'show' : ''}"
                                                    id="info-view-modal" ${not empty openInfoModal
                                                    ? 'style="display: flex;"' : '' }>
                                                    <div class="popup-content info-popup-content">
                                                        <div class="popup-action">
                                                            <button type="button" class="btn-close" id="btn-close-info"
                                                                style="font-size: 35px; margin-top: -25px; right: 5px;">&times;</button>
                                                        </div>
                                                        ...
                                                        <div class="info-display">
                                                            <div class="info-row">
                                                                ...
                                                                <span
                                                                    class="info-value">${hotelInfo.getHotelName()}</span>
                                                            </div>
                                                            <div class="info-row">
                                                                <span class="info-label">Mô tả:</span>
                                                                <span
                                                                    class="info-value">${hotelInfo.getDescription()}</span>
                                                            </div>
                                                            <div class="info-row">
                                                                <span class="info-label">Giờ check-in:</span>
                                                                <span
                                                                    class="info-value">${hotelInfo.getCheckinTime()}</span>
                                                            </div>
                                                            <div class="info-row">
                                                                <span class="info-label">Giờ check-out:</span>
                                                                <span
                                                                    class="info-value">${hotelInfo.getCheckoutTime()}</span>
                                                            </div>
                                                            <div class="info-row">
                                                                <span class="info-label">Địa chỉ:</span>
                                                                <span
                                                                    class="info-value">${hotelInfo.getAddress()}</span>
                                                            </div>
                                                            <div class="info-row">
                                                                <span class="info-label">URL địa chỉ:</span>
                                                                <span
                                                                    class="info-value">${hotelInfo.getAddressUrl()}</span>
                                                            </div>
                                                            <div class="info-row">
                                                        ...
                                                        <div class="popup-action">
                                                            <button type="button" class="btn-submit"
                                                                id="btn-edit-info">Chỉnh sửa</button>
                                                        </div>
                                                    </div>
                                                </div>

                                                <div class="hotel-popup ${not empty infoEditMode ? 'show' : ''}"
                                                    id="info-edit-modal" ${not empty infoEditMode
                                                    ? 'style="display: flex;"' : '' }>
                                                    <form action="HotelInfoUpdate" method="POST" id="info-edit-form"
                                                        class="popup-content info-popup-content">
                                                        <div class="popup-action">
                                                            <button type="button" class="btn-close"
                                                                id="btn-close-info-edit"
                                                                style="font-size: 35px; margin-top: -25px; right: 5px;">&times;</button>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="description" class="popup-input-field"
                                                                rows="3">${hotelInfo.getDescription()}</textarea>
                                                        </div>
                                                        ...
                                                        <div class="popup-action">
                                                            <button type="submit" class="btn-submit">Lưu thay
                                                                đổi</button>
                                                        </div>
                                                    </form>
                                                </div>
                                                    ...
                                                    <div class="images-grid">
                                                        <div class="image-card">
                                                            <div class="image-wrapper">
                                                                <img src="${bannerImage.getImageUrl()}" alt="Banner"
                                                                    class="hotel-image banner-image">
                                                            ...
                                                            <div class="image-card">
                                                                <div class="image-wrapper">
                                                                    <img src="${img.getImageUrl()}"
                                                                        alt="Ảnh ${loop.index + 1}" class="hotel-image">
                                                                    <button type="button" class="btn-edit-image"
                                                                        onclick="openImageEditModal(${img.getImageId()}, '${img.getImageUrl()}', 'Ảnh nhỏ ${loop.index + 1}')">
                                                                        Chỉnh sửa
                                                                    </button>
                                                                </div>
                                                                <span class="image-label">Ảnh nhỏ ${loop.index +
                                                                    1}</span>
                                                            </div>
                                                        </c:forEach>
                                                    </div>
                                                ...
                                                <div class="hotel-popup" id="image-edit-modal">
                                                    <form action="HotelImageUpdate" method="POST" id="image-edit-form"
                                                        class="popup-content">
                                                        <div class="popup-action">
                                                            <button type="button" class="btn-close" id="btn-close-image"
                                                                style="font-size: 35px; margin-top: -25px; right: 5px;">&times;</button>

                                                        </div>
                                                        <h2 class="popup-title" id="image-modal-title">Chỉnh sửa ảnh
                                                        </h2>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="imageUrl" id="edit-image-url"
                                                                class="popup-input-field" required>
                                                        </div>
                                                ...
                                                <div class="news-section" id="news-section">
                                                    ...
                                                    <div class="search-container">
                                                        <form action="HotelInfo" method="GET" class="search-form"
                                                            id="news-filter-form">
                                                            ...
                                                            <select name="status" class="filter-select">
                                                                <option value="all" ${status=='all' || empty status
                                                        ...
                                                        <div class="header-action">
                                                            <button id="btn-create-news" class="btn-primary">Thêm bài
                                                                viết mới</button>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <tbody class="data-table-tbody">
                                                            <c:forEach var="news" items="${newsList}" varStatus="loop">
                                                                <tr class="${news.isActive() ? '' : 'row-inactive'}"
                                                                    ...
                                                                    <td class="col-stt">${(currentPage - 1) * 10 +
                                                                        loop.index + 1}</td>
                                                                    <td class="col-title">
                                                                    ...
                                                                    <td class="col-content">
                                                                        ${news.getContent().length() > 100 ?
                                                                        news.getContent().substring(0,
                                                                        100).concat('...') : news.getContent()}
                                                                    </td>
                                                                    <td class="col-status">
                                                                        <div
                                                                            class="news-status ${news.isActive() ? 'status-active' : 'status-inactive'}">
                                                                            ${news.isActive() ? 'HOẠT ĐỘNG' : 'TẠM
                                                                            DỪNG'}
                                                                        </div>
                                                                    </td>
                                                                    <td class="btn-action">
                                                                        <a class="btn-edit"
                                                                            href="HotelNewsEdit?newsId=${news.getNewsId()}&page=${currentPage}&keyword=${keyword}&status=${status}">Sửa</a>
                                                                        <form action="HotelNewsDelete" method="post"
                                                                            style="display: inline-block; margin: 0;">
                                                                            <input type="hidden" name="newsId"
                                                                                value="${news.getNewsId()}">
                                                                            <button type="submit"
                                                                                onclick="return confirm('Bạn có chắc muốn xóa bài viết ${news.getTitle()}?')">Xóa</button>
                                                                        </form>
                                                                    </td>
                                                                </tr>
                                                            </c:forEach>
                                                ...
                                                <div class="hotel-popup" id="news-detail-modal">
                                                    <div class="popup-content news-detail-content">
                                                        ...
                                                        <div class="popup-action">
                                                            <button type="button" class="btn-submit"
                                                                id="btn-edit-from-detail">Chỉnh sửa</button>
                                                        </div>
                                                    </div>
                                                </div>

                                                <div class="hotel-popup ${not empty openCreateModal ? 'show' : ''}"
                                                    id="news-create-modal" ${not empty openCreateModal
                                                    ? 'style="display: flex;"' : '' }>
                                                    <form action="HotelNewsCreate" method="POST" id="news-create-form"
                                                        class="popup-content">
                                                        <div class="popup-action">
                                                            <button type="button" class="btn-close"
                                                                id="btn-close-create"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="content" class="popup-input-field" rows="5"
                                                                required>${keepContent}</textarea>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="input-label">Link ảnh</label>
                                                            <input type="text" name="imageUrl" id="edit-image-url"
                                                                class="popup-input-field" value="${keepImageUrl}">
                                                        </div>
                                                ...
                                                <div class="hotel-popup ${not empty newsToEdit ? 'show' : ''}"
                                                    id="news-edit-modal" ${not empty newsToEdit
                                                    ? 'style="display: flex;"' : '' }>
                                                    <form action="HotelNewsEdit" method="POST" id="news-edit-form"
                                                        class="popup-content">
                                                        <div class="popup-action">
                                                            <button type="button" class="btn-close" id="btn-close-edit"
                                                                style="font-size: 35px; margin-top: -25px; right: 5px;">&times;</button>
                                                        </div>
                                                        <h2 class="popup-title">Chỉnh sửa bài viết</h2>

                                                        <input type="hidden" name="newsId"
                                                            value="${newsToEdit.getNewsId()}">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="input-label">Nội dung*</label>
                                                            <textarea name="content" class="popup-input-field" rows="5"
                                                                required>${newsToEdit.getContent()}</textarea>
                                                        </div>
                                            ...
                                            <script
                                                src="<%=request.getContextPath()%>/view/assets/javascript/alert.js"></script>
                                            <script
                                                src="<%=request.getContextPath()%>/view/assets/javascript/hotel-info-management.js"></script>
                                            <script
                                                src="<%=request.getContextPath()%>/view/assets/javascript/upload-img.js"></script>
                                </body>
