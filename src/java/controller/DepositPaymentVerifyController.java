 ...
 * @since 2026-06-15
 */
public class DepositPaymentVerifyController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (depositIdStr == null || depositIdStr.trim().isEmpty()) {
            session.setAttribute("errorMessage", "Không tìm thấy khoản thanh toán cần xác nhận.");
    ...
    public String getServletInfo() {
        return "Deposit Payment Verify Controller";
    }
}